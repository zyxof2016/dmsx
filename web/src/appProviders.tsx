...
const dictionaries: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    "nav.auditLogs": "审计日志",
    "nav.group.platformWorkbench": "平台工作台",
    "nav.group.platformPermissions": "权限中心",
    "nav.group.platformGovernance": "运营治理",
    "nav.group.platformOperations": "平台运维",
    "nav.group.tenantWorkbench": "租户工作台",
    "nav.group.tenantDeviceOps": "设备运营",
    "nav.group.tenantSecurity": "策略安全",
    "nav.group.tenantDelivery": "交付配置",
    "nav.platformOverview": "平台总览",
    "nav.platformPermissionsOverview": "权限总览",
    "nav.platformPermissionRoles": "角色管理",
    "nav.platformPermissionUsers": "用户管理",
    "nav.platformPermissionMenus": "菜单管理",
    "nav.platformPermissionPolicy": "权限策略",
    "nav.platformTenants": "租户管理",
    "nav.platformQuotas": "配额治理",
    "nav.platformAudit": "全局审计",
    "nav.platformHealth": "运行健康",
  ...
  en: {
    ...
    "nav.group.platformWorkbench": "Platform",
    "nav.group.platformPermissions": "Permissions",
    "nav.group.platformGovernance": "Governance",
    "nav.group.platformOperations": "Operations",
    "nav.group.tenantWorkbench": "Workspace",
    "nav.group.tenantDeviceOps": "Device Ops",
    "nav.group.tenantSecurity": "Security",
    "nav.group.tenantDelivery": "Delivery",
    "nav.platformOverview": "Platform Overview",
    "nav.platformPermissionsOverview": "Permission Overview",
    "nav.platformPermissionRoles": "Roles",
    "nav.platformPermissionUsers": "Users",
    "nav.platformPermissionMenus": "Menus",
    "nav.platformPermissionPolicy": "Permission Policy",
    "nav.platformTenants": "Tenants",
    "nav.platformQuotas": "Quotas",
    "nav.platformAudit": "Global Audit",
    "nav.platformHealth": "Health",
...
function getEffectiveRolesForTenant(
  ...
  if (!claims) return [];
  return claims.tenantRoles[tenantId] ?? claims.roles.filter((role) => !["PlatformAdmin", "PlatformViewer"].includes(role));
}
